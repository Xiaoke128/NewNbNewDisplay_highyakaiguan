...
#define MODBUS_WL_VOL_VALUE_GET_START_REG		0x0417
#define MODBUS_WL_VOL_VALUE_GET_END_REG			0x042A

#define MODBUS_WL_SET_GET_DEV_ID_START_REG	0x042B
#define MODBUS_WL_SET_GET_DEV_ID_END_REG	  0x0452
